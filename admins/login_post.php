...
$select_email = "SELECT COUNT(*) as email_exist, name, profile_photo, designation, role FROM admins WHERE email='$email'";
...
if($after_assoc['email_exist'] == 1){
    $select_email2 = "SELECT * FROM admins WHERE email='$email'";
   ...
   if( password_verify($password, $after_assoc2['password'])){
       ...
       $_SESSION['designation']=$after_assoc2['designation'];

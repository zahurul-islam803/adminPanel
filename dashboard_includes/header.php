...
$select_admin = "SELECT id FROM admins WHERE status=0";
  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="../admins/register.php" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="../admins/admins.php" class="nav-link">Admin Info</a></li>
          <?php if($_SESSION['role'] !=0 && $_SESSION['role'] !=3) {?>
          <li class="nav-item"><a href="../admins/trash.php" class="nav-link">Trash</a></li>
          <?php } ?>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="fa fa-free-code-camp" style="font-size:18px;"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="../educations/education.php" class="nav-link">Education Info</a></li>
          <?php if($_SESSION['role'] !=0 && $_SESSION['role'] !=3) {?>
          <li class="nav-item"><a href="../educations/add_education.php" class="nav-link">Add Education</a></li>          
          <?php } ?>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="../abouts/about.php" class="nav-link">About Info</a></li>
          
          <li class="nav-item"><a href="../images/image.php" class="nav-link">Image Info</a></li>
          <?php if($_SESSION['role'] !=0 && $_SESSION['role'] !=3) {?>
          <li class="nav-item"><a href="../abouts/add_about.php" class="nav-link">Add About</a></li>          
          <li class="nav-item"><a href="../images/add_image.php" class="nav-link">Add Image</a></li>          
          <li class="nav-item"><a href="../abouts/trash_about.php" class="nav-link">Trash</a></li>          
          <?php } ?>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="../services/add_service.php" class="nav-link">Add Service</a></li>
          <?php if($_SESSION['role'] !=0 && $_SESSION['role'] !=3) {?>
          <li class="nav-item"><a href="../services/service.php" class="nav-link">Service Info</a></li>
          <li class="nav-item"><a href="../services/trash_service.php" class="nav-link">Trash</a></li>
          <?php } ?>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="../counters/add_counter.php" class="nav-link">Add Counter</a></li>
          <?php if($_SESSION['role'] !=0 && $_SESSION['role'] !=3) {?>
          <li class="nav-item"><a href="../counters/counter.php" class="nav-link">Counter Info</a></li>
          <?php } ?>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="../brands/add_brand.php" class="nav-link">Add Brand</a></li>
          <?php if($_SESSION['role'] !=0 && $_SESSION['role'] !=3) {?>
          <li class="nav-item"><a href="../brands/brand.php" class="nav-link">Brand Info</a></li>
          <?php } ?>
        </ul>
        ...
        <a href="../admins/inbox.php" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="../contacts/add_contact.php" class="nav-link">Add Contact</a></li>
          <?php if($_SESSION['role'] !=0 && $_SESSION['role'] !=3) {?>
          <li class="nav-item"><a href="../contacts/contacts.php" class="nav-link">Contact Info</a></li>
          <?php } ?>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="../portfolios/add_portfolio.php" class="nav-link">Add Portfolio</a></li>
          <?php if($_SESSION['role'] !=0 && $_SESSION['role'] !=3) {?>
          <li class="nav-item"><a href="../portfolios/portfolios.php" class="nav-link">Portfolio Info</a></li>
          <?php } ?>
        </ul>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="../uploads/admins/<?=$_SESSION['profile_photo']?>" class="wd-32 rounded-circle" alt="">
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">

              
                     <li><a href="../admins/edit.php?id=<?=$_SESSION['login_id']?>"><i class="icon ion-ios-person-outline"></i>Edit Profile</a></li>
                 
                <li><a href=""><i class="icon ion-ios-gear-outline"></i> Settings</a></li>
                <li><a href=""><i class="icon ion-ios-download-outline"></i> Downloads</a></li>
                <li><a href=""><i class="icon ion-ios-star-outline"></i> Favorites</a></li>
                <li><a href=""><i class="icon ion-ios-folder-outline"></i> Collections</a></li>
                <li><a href="../admins/logout.php"><i class="icon ion-power"></i> Sign Out</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
